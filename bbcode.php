...
/*  https://github.com/mashiox/BBCode-Parser/blob/master/bbcode.php
------------------------------
...
/*monkey13omb additions = */function replacecodetag($matches){ 
return "<div class=\"codebox\" style=\"width:700px;\"><code width=\"700px\" class=\"prettyprint\">".parse_html($matches[1])."</code></div>"; }
...
//'#\[br\]#si' => ($xhtml ? '<br />' : '<br>'),
                ...
                '#\[style=\'(.*?)\'\](.*?)\[/style\]#si' => '<span style="\\1" >\\2</span>',
'#\[code\](.*)?\[\/code\]#siU' => '<code class="prettyprint">$1</code>',
);
...
if($search == "#\[code\](.*)?\[\/code\]#siU"){ $callback = 1; }

if($callback == 1){
$text = preg_replace_callback($search,'replacecodetag',$text);
...
//$text = preg_replace('#\<code class="prettyprint"\>(.*)\</code\>#si', parse_html('$1'),$text);
